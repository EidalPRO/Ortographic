...
if ($nombreUsuario !== null) {
    ...
    if ($resultadoConsultaCodigo->num_rows > 0) {
        ...
        if ($resultadoTiempoExistente->num_rows > 0) {
            ...
            $consultaActualizar = "UPDATE Estadisticas SET tiempo_total_practica = $tiempoTotalActualizado, tema_4_porcentaje = $porcentajeEfectividad WHERE codigo_sala = '$codigoSala' AND usuario_nombre = '$nombreUsuario'";
